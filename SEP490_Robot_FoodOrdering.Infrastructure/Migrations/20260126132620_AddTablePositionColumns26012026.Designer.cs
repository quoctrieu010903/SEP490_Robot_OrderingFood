...
namespace SEP490_Robot_FoodOrdering.Infrastructure.Migrations
{
    ...
    [Migration("20260126132620_AddTablePositionColumns26012026")]
    partial class AddTablePositionColumns26012026
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SEP490_Robot_FoodOrdering.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.Property<DateTime?>("RemakedTime")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("SEP490_Robot_FoodOrdering.Domain.Entities.QuickServeItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SEP490_Robot_FoodOrdering.Domain.Entities.InvoiceDetail", b =>
                {
                    b.HasOne("SEP490_Robot_FoodOrdering.Domain.Entities.Invoice", "Invoices")
                        .WithMany("Details")
            ...
            modelBuilder.Entity("SEP490_Robot_FoodOrdering.Domain.Entities.QuickServeItem", b =>
                {
                    b.HasOne("SEP490_Robot_FoodOrdering.Domain.Entities.Complain", "Complain")
                        .WithMany("QuickServeItems")
